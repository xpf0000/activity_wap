        ...
        ************   Navigation / Router   ************
        ...
        app.router = {
            ...
            animatePages: function (leftPage, rightPage, direction, view) {
                // Loading new page
                var removeClasses = 'page-on-center page-on-right page-on-left page-on-back page-on-bottom';
                ...
                if (direction === 'to-top') {
                    leftPage.removeClass(removeClasses).addClass('page-from-center-to-top');
                    rightPage.removeClass(removeClasses).addClass('page-from-bottom-to-center');
                }

                if (direction === 'to-bottom') {
                    leftPage.removeClass(removeClasses).addClass('page-from-top-to-center');
                    rightPage.removeClass(removeClasses).addClass('page-from-center-to-bottom');
                }
        ...
        app.router._load = function (view, options) {
            ...
            if (app.params.pushState && !options.reloadPrevious && view.main)  {
                ...
                if (pushState) {
                    if (!isDynamicPage && !pageName) {
                        ...
                        var obj = {url: url, viewIndex: app.views.indexOf(view)};

                        history[method](obj, '', pushStateRoot + app.params.pushStateSeparator + url);
                    }
            ...
            function afterAnimation() {
                ...
                {
                    newPage.removeClass('page-from-bottom-to-center page-from-right-to-center page-on-top page-on-bottom page-on-right page-on-left').addClass('page-on-center');
                    oldPage.removeClass('page-from-center-to-top page-from-center-to-left page-on-top page-on-bottom page-on-center page-on-right').addClass('page-on-top');
                }
                else
                {
            ...
            if (animatePages) {
                ...
                if (app.params.material && app.params.materialPageLoadDelay) {
                    setTimeout(function () {
                        ...
                        if(options.modal == true)
                        {
                            app.router.animatePages(oldPage, newPage, 'to-top', view);
                        }
                        else
                        {
        ...
        app.router._back = function (view, options) {
            ...
            function animateBack() {
                ...
                if (animatePages) {
                    ...
                    if(oldPage[0].innerHTML.indexOf("data-modal=\"true\"") > 0)
                    {
                        app.router.animatePages(newPage, oldPage, 'to-bottom', view);
                    }
                    else
                    {
        ...
        app.router.afterBack = function (view, oldPage, newPage) {
            ...
            if (view.params.domCache && view.initialPages.indexOf(oldPage[0]) >= 0) {
                oldPage.removeClass('page-from-center-to-right page-from-center-to-bottom').addClass('cached');
            }
            else {
            ...
            newPage.removeClass('page-from-left-to-center page-from-top-to-center page-on-left page-on-top').addClass('page-on-center');
            view.allowPageChange = true;
        ...
        app.openModal = function (modal) {
            ...
            if (!isLoginScreen && !isPickerModal) {
                ...
                if ($('.popup-overlay').length === 0 && isPopup) {
                    ...
                    modal[0].parentNode.insertBefore(div,modal[0]);
        ...
        ************   Handle Browser's History   ************
        ...
        app.initPushState = function () {
            ...
            function handlePopState(e) {
                ...
                var animatePages = true;

                if (app.params.pushStateNoAnimation === true) animatePages = false;

                if(stateUrl == view.url && animatePages && !view.swipeBack)
                {
                    app.router.back(view, {url:window.location.href, animatePages: animatePages, pushState: false});
                    return;
                }

                view.swipeBack = false;
                ...
                if (stateUrl !== view.url) {
                    ...
                    if (view.history.indexOf(stateUrl) >= 0) {
                        ...
                        if (view.allowPageChange) {
                            ...
                            app.router.back(view, {url:stateUrl, animatePages: animatePages, pushState: false});
                        }
                        else {
                            //app.router.back(stateUrl);
        ...
        var Calendar = function (params) {
            ...
            p.open = function () {
                ...
                if (!p.opened) {
                    ...
                    app.root.append('<div class="popup-overlay modal-overlay-visible"></div>');
